        ...
        <div class="season-info">
            ...
            <div class="season-specs">
                ...
                <div class="season-spec">
                    ...
                    <div class="spec-value">4.88 GB</div>
                </div>
                <div class="season-spec">
        ...
        <div class="episodes-grid">
            <div class="episode-card">
                ...
                <div class="episode-specs">
                    <div class="episode-spec">
                        ...
                        <div class="episode-spec-value">2.37 GB</div>
                    </div>
                    <div class="episode-spec">
                        <div class="episode-spec-label">DURACIÓN TOTAL</div>
                        <div class="episode-spec-value">~66 min
                      </div>
                    </div>
                </div>
                <a class="download-button" href="https://tpi.li/MRv3Z0MB1" target="_blank">
                    <span>📥</span>
                    <span>DESCARGAR</span>
                </a>
            </div>
          ...
          <div class="episode-card">
                ...
                <div class="episode-specs">
                    <div class="episode-spec">
                        <div class="episode-spec-label">PESO</div>
                        <div class="episode-spec-value">2.51 GB</div>
                    </div>
                    <div class="episode-spec">
                        <div class="episode-spec-label">DURACIÓN TOTAL</div>
                        <div class="episode-spec-value">~59 min</div>
                    </div>
                </div>
                <a class="download-button" href="https://tpi.li/MRv3Z0MB3" target="_blank">
                    <span>📥</span>
                    <span>DESCARGAR</span>
                </a>
            </div>
